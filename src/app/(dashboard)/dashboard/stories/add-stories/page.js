  ...
  return (
    <MainCard title={`Episode ${index + 1}`} sx={{ mt: 2 }}>
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          <TextField fullWidth label="Duration" name="duration" value={data.duration || ''} onChange={handleChange} placeholder="HH:MM" />
        </Grid>
                    ...
                    <Grid item xs={12} sm={6}>
                      ...
                      >
                        {bookType?.data?.map((item) => (
                          <MenuItem value={item.type_id} id={item.type_id}>
                            {item.type_name}
                          </MenuItem>
                        ))}
                      </TextField>
              ...
              <Grid item xs={12} md={6}>
                <Stack spacing={2}>
                  ...
                  <TextField
                    ...
                    fullWidth
                    label="Title"
                    value={TamilstoryTitle}
                    onChange={(e) => setTamilstoryTitle(e.target.value)}
                    placeholder="Enter Title"
                  />
                  <TextField
                    ...
                    rows={4}
                    label="Description"
                    value={TamilstoryDescription}
                    onChange={(e) => setTamilstoryDescription(e.target.value)}
                  ...
                  <TextField
                    ...
                    fullWidth
                    label="Credits"
                    value={TamilstoryCredits}
                    onChange={(e) => setTamilstoryCredits(e.target.value)}
                    placeholder="Enter Credits"
                  />
                </Stack>
              </Grid>
              ...
              <Grid item xs={12} md={6}>
                <Stack spacing={2}>
                  ...
                  <TextField
                    ...
                    fullWidth
                    label="Title"
                    value={KannadastoryTitle}
                    onChange={(e) => setKannadastoryTitle(e.target.value)}
                    placeholder="Enter Title"
                  />
                  <TextField
                    id="kannada-description"
                    fullWidth
                    multiline
                    rows={4}
                    label="Description"
                    value={KannadastoryDescription}
                    onChange={(e) => setKannadastoryDescription(e.target.value)}
                    placeholder="Description in Kannada"
                  />
                  <TextField
                    id="kannada-credits"
                    fullWidth
                    label="Credits"
                    value={KannadastoryCredits}
                    onChange={(e) => setKannadastoryCredits(e.target.value)}
                    placeholder="Enter Credits"
                  />
                </Stack>
              </Grid>
              ...
              <Grid item xs={12} md={6}>
                <Stack spacing={2}>
                  ...
                  <TextField
                    ...
                    fullWidth
                    label="Title"
                    value={TelugustoryTitle}
                    onChange={(e) => setTelugustoryTitle(e.target.value)}
                    placeholder="Enter Title"
                  />
                  <TextField
                    ...
                    rows={4}
                    label="Description"
                    value={TelugustoryDescription}
                    onChange={(e) => setTelugustoryDescription(e.target.value)}
                  ...
                  <TextField
                    ...
                    fullWidth
                    label="Credits"
                    value={TelugustoryCredits}
                    onChange={(e) => setTelugustoryCredits(e.target.value)}
                    placeholder="Enter Credits"
                  />
                </Stack>
              </Grid>
              ...
              <Grid item xs={12} md={6}>
                <Stack spacing={2}>
                  ...
                  <TextField
                    ...
                    fullWidth
                    label="Title"
                    value={MalayalamstoryTitle}
                    onChange={(e) => setMalayalamstoryTitle(e.target.value)}
                    placeholder="Enter Title"
                  />
                  <TextField
                    id="malayalam-description"
                    fullWidth
                    multiline
                    rows={4}
                    label="Description"
                    value={MalayalamstoryDescription}
                    onChange={(e) => setMalayalamstoryDescription(e.target.value)}
                    placeholder="Description in Malayalam"
                  />
                  <TextField
                    id="malayalam-credits"
                    fullWidth
                    label="Credits"
                    value={MalayalamstoryCredits}
                    onChange={(e) => setMalayalamstoryCredits(e.target.value)}
                    placeholder="Enter Credits"
                  />
                </Stack>
              </Grid>
          ...
          <CustomTabPanel value={value} index={2}>
            ...
            <Box sx={{ mt: 3 }}>
              {episodeList.map((episodeData, index) => (
                <EpisodeForm key={index} index={index} data={episodeData} onChange={handleEpisodeChange} />
              ))}
            </Box>
