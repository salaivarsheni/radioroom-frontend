...
const AddEpisodePage = () => {
        ...
        const submitEpisodes = async () => {
            for (const ep of newEpisodes) {
                ...
                try {
                    ...
                    if (response.data.status !== 1) { // Assuming 1 is success based on AddStoriesPage
    ...
    const handleDeactivate = async (chapterId) => {
        const confirmDeactivate = window.confirm(
            "Are you sure you want to deactivate this episode?"
        );
                                        ...
                                        <TableCell>
                                            {ep.status === 1 ? (
                                                <Button
                                                    ...
                                                    color="error"
                                                    size="small"
                                                    onClick={() => handleDeactivate(ep.chapter_id)}
                                                >
                                                    Deactivate
                                                </Button>
                                            ) : (
                                                <Button
                                                    ...
                                                    color="success"
                                                    size="small"
                                                    onClick={() => handleActivate(ep.chapter_id)}
                                                >
                                                    Activate
                                                </Button>
                                            )}
