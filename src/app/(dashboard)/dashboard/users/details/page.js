          ...
          <CustomTabPanel value={value} index={5}>
            <Box sx={{ minWidth: 120, maxWidth: 300, mt: 2 }}>
              <FormControl fullWidth>
                ...
                <Select labelId="plan-select-label" id="plan-select" value={plan} label="Select Plan" onChange={handlePlanChange}>
                ...
                <Box sx={{ mt: 2 }}>
                  <Button variant="contained" onClick={handlePlanSubmit}>
                    Add Plan
                  </Button>
                </Box>
              </FormControl>
