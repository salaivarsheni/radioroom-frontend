  ...
  return (
    <Grid container spacing={3}>
      <Grid item xs={12} md={4} lg={3} sm={6}>
        <ReportCard primary="$30200" secondary="Registered users" color="secondary.main" iconPrimary={Chart} />
      </Grid>
      <Grid item xs={12} md={4} lg={3} sm={6}>
        <ReportCard primary="145" secondary="Task" color="error.main" iconPrimary={Calendar} />
      </Grid>
      <Grid item xs={12} md={4} lg={3} sm={6}>
        <ReportCard primary="290+" secondary="Stories" color="success.main" iconPrimary={DocumentText} />
      </Grid>
      <Grid item xs={12} md={4} lg={3} sm={6}>
      ...
      <Grid item xs={12} sm={6} md={4} lg={3}>
        <AnalyticEcommerce title="Total Stories" count="4,42,236" percentage={59.3} extra="35,000" />
      </Grid>
      <Grid item xs={12} sm={6} md={4} lg={3}>
